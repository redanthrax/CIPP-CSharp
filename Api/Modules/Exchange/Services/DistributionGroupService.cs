...
public class DistributionGroupService : IDistributionGroupService {
    ...
    public async Task<PagedResponse<DistributionGroupDto>> GetDistributionGroupsAsync(Guid tenantId, PagingParameters pagingParams, CancellationToken cancellationToken = default) {
    ...
    public async Task<DistributionGroupDto?> GetDistributionGroupAsync(Guid tenantId, string groupId, CancellationToken cancellationToken = default) {
    ...
    public async Task CreateDistributionGroupAsync(Guid tenantId, CreateDistributionGroupDto createDto, CancellationToken cancellationToken = default) {
    ...
    public async Task UpdateDistributionGroupAsync(Guid tenantId, string groupId, UpdateDistributionGroupDto updateDto, CancellationToken cancellationToken = default) {
        var parameters = new Dictionary<string, object> { { "Identity", groupId } };
    ...
    public async Task DeleteDistributionGroupAsync(Guid tenantId, string groupId, CancellationToken cancellationToken = default) {
        var parameters = new Dictionary<string, object> { { "Identity", groupId } };
        await _exoService.ExecuteCmdletNoResultAsync(tenantId, "Remove-DistributionGroup", parameters, cancellationToken);
    }

    public async Task<PagedResponse<DistributionGroupMemberDto>> GetDistributionGroupMembersAsync(Guid tenantId, string groupId, PagingParameters pagingParams, CancellationToken cancellationToken = default) {
        var parameters = new Dictionary<string, object> { { "Identity", groupId } };
    ...
    public async Task AddDistributionGroupMemberAsync(Guid tenantId, string groupId, string memberEmail, CancellationToken cancellationToken = default) {
        var parameters = new Dictionary<string, object> {
            { "Identity", groupId },
            { "Member", memberEmail }
        };
    ...
    public async Task RemoveDistributionGroupMemberAsync(Guid tenantId, string groupId, string memberEmail, CancellationToken cancellationToken = default) {
        var parameters = new Dictionary<string, object> {
            { "Identity", groupId },
            { "Member", memberEmail }
        };
